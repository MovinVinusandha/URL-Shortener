...
const LoginPage: React.FC = () => {
  ...
  const { login, token, user, authConfig } = useAuth();
          ...
          <div className="bg-background border border-border rounded-xl p-8 shadow-xl max-w-md w-full mx-auto">
              ...
              <button 
                ...
                onClick={() => {
                  if (authConfig && !authConfig.googleOAuthEnabled) {
                    toast.error('Google login is not configured on this instance. Add OAUTH_GOOGLE_CLIENT_ID to your .env file.');
                    return;
                  }
              ...
              <button 
                ...
                onClick={() => {
                  if (authConfig && !authConfig.githubOAuthEnabled) {
                    toast.error('GitHub login is not configured on this instance. Add OAUTH_GITHUB_CLIENT_ID to your .env file.');
                    return;
                  }
            ...
            <p className="text-center text-xs text-muted-foreground mt-6">
              ...
              {authConfig?.allowRegistration === false ? (
                <span className="text-muted-foreground italic" title="Public registration is disabled on this instance">
