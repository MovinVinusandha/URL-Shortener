...
public class UrlSecurityRules implements SecurityRules {
    ...
    public void configure(AuthorizeHttpRequestsConfigurer<HttpSecurity>.AuthorizationManagerRequestMatcherRegistry registry) {
        registry.requestMatchers(HttpMethod.POST, "/shorten").permitAll()
                .requestMatchers(HttpMethod.GET, "/{hash:[a-zA-Z0-9_-]+}").permitAll()
                ...
                .requestMatchers("/links/check/**").authenticated()
